...
$unapproved_comment_count = checkStatus('comments','comment_status','unapprove');
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ...
          <?php
            ...
            $element_count = [$post_count, $post_published_count, $post_draft_count, $comments_count, $unapproved_comment_count, $users_count, $subscriber_count, $category_count];
